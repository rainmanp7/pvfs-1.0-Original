/*
	pvfs_writev.c copyright (c) 1998 Clemson University, all rights reserved.
...
static char pvfs_writev_c[] = "$Header: /projects/cvsroot/pvfs/lib/pvfs_writev.c,v 1.4 2000/10/30 14:44:49 rbross Exp $";
