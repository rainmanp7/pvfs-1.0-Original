/* pvfs_ostat.c copyright (c) 1996 Rob Ross, all rights reserved.
...
static char pvfs_ostat_c[] = "$Header: /projects/cvsroot/pvfs/lib/pvfs_ostat.c,v 1.5 2000/10/30 14:44:49 rbross Exp $";

/* This file contains PVFS library call for stat.   		*/
...
int pvfs_stat(char* pathname, struct stat *buf)
{
	...
	if (pvfs_checks_disabled) return (unix_stat(pathname, buf));
